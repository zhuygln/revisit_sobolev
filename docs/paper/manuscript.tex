...
composition---as the controlling variable. In the strong-line,
...
$\tau_{\max}$ is the controlling variable. All 36 conditions fall on one
trend (Fig.~\ref{fig:breadth}) regardless of window, epoch or composition;
those enter only through the optical depths they produce. Both errors vanish
together as $\tau_{\max}\to0$---the weak-line limit both approximations
...
F10 & The separation is universal across windows, epochs and ion mixes; & \S\ref{sec:breadth} \\
    & realized $\tau_{\max}$ is the controlling variable & \\
