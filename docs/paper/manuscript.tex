...
per-line Sobolev scheme inside a scattering Monte Carlo code (TARDIS-class
macroatoms, say) is a different object, and our numbers should not be read as
bounding it; extending the harness there is the natural sequel, and is the
regime in which the leg would have to be built rather than computed.
