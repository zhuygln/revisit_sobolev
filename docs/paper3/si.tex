...
The grouped-opacity results reported in this Supplementary Information and its manuscript are \textbf{invalid}
...
\resizebox{\textwidth}{!}{\input{si_tab_robustness}}
\end{table}
...
\label{stab:chain}
\resizebox{\textwidth}{!}{\input{si_tab_chain}}
\end{table}
