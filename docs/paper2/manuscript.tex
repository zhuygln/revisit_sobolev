...
\subsection{Three velocity scales}        %% v_D (microscopic width) / Delta v_shell (forest sweep) / v_bulk (relativistic transport); eta_width = v_D/Dv_shell; beta_bulk = v_bulk/c; they answer different questions
...
\subsection{Bulk-velocity robustness}             %% E13: 0.05-0.15c shell, worldline vs frozen-first-order control, eps_best(0.1c) vs eps_best(slow)
