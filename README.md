...
| F66 | **On the xkn secular-ejecta structure with the P1 composition (2–8 d, the xkn diffusion solution as the photospheric boundary, the outer ejecta transported with explicit fluorescence), resolved, expansion and line-binned transport give the same bolometric light curve (peaks within 2 %, inside the noise; reading Gray by rule) and differ in colour: expansion a 0.3 mag blueward offset in i − K, line-binned a 0.5 mag redward one, opposite in sign and larger, its interaction count growing twenty-fold as the photosphere recedes** | [§4.61](docs/results_report.md) |
