...
| F64 | **On the Fontes et al. (2020) simplified problem (pure Nd) as a snapshot, complete thermal redistribution gives their ordering — line-binned within 0.0–0.2 mag of resolved Sobolev in colour, expansion 0.2–0.3 mag too blue — and the single switch to energy-conserving fluorescence leaves expansion unchanged while the line-binned colour error opens to 1.4–1.7 mag in r − K, in both brackets of the inner boundary** | [§4.59](docs/results_report.md) |
