...
| F63 | **Under a full macroatom (internal upward transitions under an imposed diluted Planck field) the resolved reference brightens by 1.3–1.8 mag in the optical, the expansion closure stays within 0.18 mag of it in every band, and the line-binned closure keeps +0.7 in g while its red excess vanishes and K flips to −0.25** | [§4.58](docs/results_report.md) |
