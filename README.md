...
| F65 | **Over the Fontes (2020) benchmark as a light curve (4–16 d, time-slab transport), the three opacity treatments order the same way under complete redistribution and under explicit fluorescence — resolved lowest, line-binned within 2–4 %, expansion 15–17 % brighter at the peak — and fluorescence changes the closures' colour errors, not their bolometric ones: line-binned 0.13 → 0.45 mag (J, H 0.4–0.8 mag too faint), expansion 0.20 → 0.32** | [§4.60](docs/results_report.md) |
