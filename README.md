...
|---|---|
| Sobolev approximation proper (`e^−τs` per line) | **≈5–8%** |
...
and it does not vanish as line widths shrink. Across 36 conditions spanning
...
**[docs/paper/manuscript.pdf](docs/paper/manuscript.pdf)** — 23 pp, working
...
tests/         27 tests pinning the physics of every module
